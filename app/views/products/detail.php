                    ...
                    <div class="row g-1">
                        <div class="col-12">
                            <div class="custom-detail__container-img-main">
                                <img src="<?=_WEB_ROOT_?>/assets/img/pro/<?=$pros_image[0]['url_image']?>" class="custom-detail__img--main" alt="">
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="d-flex gap-2 align-items-center justify-content-star scroll">
                                <?php foreach($pros_image as $pro_img): ?>
                                <div onclick="change_img_main(this, '.custom-detail__img--item')" class="custom-detail__img--item">
                                    <img src="<?=_WEB_ROOT_?>/assets/img/pro/<?=$pro_img['url_image']?>" class="cursor-pointer" alt="">
                                </div>
                                <?php endforeach ?>
                            </div>
                        </div>
                ...
                <div class="col-12 col-lg-7 col-md-6">
                    <div class="mt-3 d-flex flex-column h-100 gap-4">
                        ...
                        <div class="d-flex align-items-center custom-detail__price gap-2">
                            <p class="m-0"><?=number_format($pro_id['price'] - ($pro_id['price'] * ($pro_id['discount_percent'] /100)))?> đ</p>
                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-10">
                                <div class="d-flex align-items-center gap-3 ">
                                    <div class="d-flex custom-detail__size align-items-center flex-wrap gap-1 show__size">
                        ...
                        <?php if(isset($size_pro_id) && !empty($size_pro_id)) : ?>           
                            ...
                            <div class="col-10">
                                <div class="d-flex align-items-center gap-3">
                                    <div class="d-flex custom-detail__size align-items-center gap-1 show__size flex-wrap">
                                        <?php foreach ($size_pro_id as $size): ?>
                                        <button onclick="get_quantity(this, '.size', '<?=$size['pro_id']?>', '<?=$size['cor_id']?>', '<?=$size['size_id']?>')" 
                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-10">
                                <div
                                    ...
                                    <button onclick="change_quantity_detail()"><i class="fa-solid fa-minus"></i></button>
                        ...
                        <div class="d-flex align-items-center gap-2 custom-detail__btn--submit">
                            <form action="<?=_WEB_ROOT_?>/save_cart" method="POST" onclick="return valid_handle_cart()">
                                <input type="hidden" name="pro_quantity" class="quantity__handle">
                                <input type="hidden" name="pro_variant_id" class="variant__handle">
                                <input type="hidden" name="user_id" value="<?= $_SESSION['user']['id'] ?? '' ?>" class="user__id">
                            ...
                            <form action="">
                                ...
                                <input type="hidden" name="pro_variant_id" class="variant__handle">
                                <input type="hidden" name="user_id" value="<?= $_SESSION['user']['id'] ?? '' ?>" class="user__id">
                                <button type="submit"  class="custom-btn btn-by__cart custom-btn__primary">Mua hàng</button>
                            </form>
                        </div>
                    </div>
                </div>
        ...
        <div class="row my-4">
                        ...
                        <div class="custom-detail__rating ">
                            <div class="row align-items-center mt-3 py-5 px-1 g-3 custom-detail__rating--box">
                                <div class="col-12 col-md-3 text-center">
                                    ...
                                    <div class="d-flex text-warning mt-1 fs-4 justify-content-center align-items-center">
                                        <i class="fa-solid fa-star"></i>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-11 col-md-10 col-10">
                                    ...
                                    <div class="d-flex gap-1 flex-wrap custom-detail__img--rate scroll">
                                        <img src="https://down-vn.img.susercontent.com/file/72db7c09a208bd3d60f1b0d67657df03@resize_w450_nl.webp" alt="">
                                        <img src="https://down-vn.img.susercontent.com/file/72db7c09a208bd3d60f1b0d67657df03@resize_w450_nl.webp" alt="">
                                        <img src="https://down-vn.img.susercontent.com/file/72db7c09a208bd3d60f1b0d67657df03@resize_w450_nl.webp" alt="">
                                        <img src="https://down-vn.img.susercontent.com/file/72db7c09a208bd3d60f1b0d67657df03@resize_w450_nl.webp" alt="">
                                        <img src="https://down-vn.img.susercontent.com/file/72db7c09a208bd3d60f1b0d67657df03@resize_w450_nl.webp" alt="">
            ...
            <div class="col-md-3 col-lg-2">
                <div class="bg-white p-2">
                    <h3 class="fw-normal text-secondary fs-4 mb-3">TOP SẢN PHẨM LIÊN QUAN</h3>
                    <div class="row">
                        <div class="col-md-12 col-sm-3 col-4">
                            <a href="#" class="custom-pro__item">
                                <div
                                    class="custom-pro__item__img"
                                    style="background-image: url(#);"></div>
                                <h4 class="custom-pro__item__name">
                                    Bộ kem đặc trị vùng mắt Ohui Age Recovery Wrinkle Cut
                                    Serum.
                                </h4>
                                <div class="custom-pro__item__price">
                                    <span class="custom-pro__item__price-old">2.300.000đ</span>
                                    <span class="custom-pro__item__price-current">2.070.000đ</span>
                                </div>

                                <div class="custom-pro__item__sale-off">
                                    <span class="custom-pro__item__sale-off-percent">43%</span>
